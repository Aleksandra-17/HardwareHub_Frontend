...
export const devices: Device[] = [
  ...
  { id: 'd7', inventoryNumber: 'INV-2023-011', name: 'Ноутбук ASUS VivoBook 15', deviceTypeId: 'dt1', serialNumber: 'SN-ASUS-011', model: 'X1500EA', manufacturer: 'ASUS', status: 'reserve', locationId: 'l4', personId: '', commissionDate: '2023-07-20', lastCheckDate: '2025-07-01', notes: 'В резерве, исправен', purchasePrice: 55000, purchaseDate: '2023-07-01', qrCode: 'INV-2023-011' },
  { id: 'd8', inventoryNumber: 'INV-2022-005', name: 'ПК HP ProDesk 400', deviceTypeId: 'dt2', serialNumber: 'SN-HP-005', model: 'ProDesk 400 G7', manufacturer: 'HP', status: 'decommissioned', locationId: 'l2', personId: '', commissionDate: '2022-01-10', lastCheckDate: '2024-12-15', notes: 'Списан, устарел', purchasePrice: 45000, purchaseDate: '2021-12-20', qrCode: 'INV-2022-005' },
